...
export default function Home({ poolCount, guessCount, usersCount }: HomeProps) {
  ...
  const createPool = async (event: FormEvent) => {
    ...
    try {
      ...
      alert("Criado com sucesso! Codigo copiado para a area de transferencia.");
      setPoolTitle("");
    } catch (err) {
    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <div className="flex mt-10 items-center gap-2 ">
          <Image src={usersAvatar} alt="Avatar exemplo" />
      ...
      <Image src={appPreviewImg} alt="Nlw Copa"></Image>
    </div>
  );
}
